      ...
      <div className='flex flex-wrap'>
        <div className='w-full lg:w-1/2'>
            <div className='flex flex-col items-center lg:items-start'>
                ...
                initial="hidden"
                animate="visible"
                className='pb-16 text-6xl font-thin tracking-tight lg:mt-16 lg:text-8xl'>Juan José Arenas Gaviria</motion.h1>
                <motion.span 
        ...
        <div className='w-full lg:w-1/2 lg:p-8'>
            <div className='flex justify-center'>
                ...
                src={profilePic} alt="Juan Arenas" className='w-96 rounded-[500px] mt-20 lg:ml-44 border-2 gap-12  border-purple-500 '/>
            </div>
        </div>
      </div>
    </div>
